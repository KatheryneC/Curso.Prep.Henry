...
function combinarNombres(nombre, apellido) {
  ...
  // Ejemplo: "Soy", "Henry" -> "Soy Henry"
    // Tu código:
    var nombre = "Katheryne";
    var apellido = "Canon";
    return var nombre + var apellido;
}
...
function areaDelTriangulo(base, altura){
  ...
  //Escribe tu código aquí
    var base;
    var altura;
    var area;                                                                                                          printf("ingrese la base\n");                                                                                            scanf("%d" ,&base);                                                                                                     printf("ingrese la altura\n");                                                                                           scanf("%d" ,&altura);                                                                                                    area = (base * altura) / 2;
}
...
function deEuroAdolar(euro){
  ...
  //Escribe tu código aquí
    ...
    {euro = parseFloat(1.2);
     ...
     document.getElementById("total").innerHTML = dollar + " dollares son ... " + resultado.toFixed(2); 
    }
}
